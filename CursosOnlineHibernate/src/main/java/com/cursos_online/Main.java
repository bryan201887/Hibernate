...
public class Main {
	...
	public static void main(String[] args) {
		...
		//ingresar estudiante
				...
				Estudiante est1 = new Estudiante ("Marcela", "Matamoros");
				Estudiante est2 = new Estudiante ("Carla","Holguin");
		...
		//modificar estudiantes
				...
				modificaEstudiante(4,"Lorena","Lorense");
